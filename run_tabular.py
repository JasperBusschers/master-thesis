...
def arguments():
    ...
    parse.add_argument('--eps', type=float, default=0.10, help='epsilon')
    ...
    parse.add_argument('--eps_decay', type=float, default=1., help='learning rate')
    parse.add_argument('--high', type=int, default=100, help='higher boundary for Q_val initialization')
