...
def arguments():
    ...
    parse.add_argument('--eps_decay', type=float, default=0.997, help='learning rate')
    parse.add_argument('--high', type=int, default=5, help='higher boundary for Q_val initialization')
    ...
    parse.add_argument('--weight1', type=float, default=0.5, help='weight for objective 1')
